...
int subMenu()
{
    ...
    do
    {
        ...
        {
        case 1:
            printf("Eligio 1-Mostrar Alumno de una carrera\n");

            break;

        case 2:
            printf("Eligio 2-Mostrar Alumnos por carrera\n");

            break;

        case 3:
            printf("Eligio 3-Mostrar lacantidad de Alumnos por carrera\n");

            break;

        case 4:
            printf("Eligio 4-Mostrar la carrera con mas inscriptos\n");

            break;

        case 5:

            printf(" Eligio 5-Mostrar mejor promedio por carrera\n");

            break;

        case 6:
            printf("Eligio 6-Mostrar alumnos Varones\n");

            break;
        case 7:
            printf("Eligio 7-Mostrar mujeres de alguna carrera\n");

            break;
        case 8:
            printf("Eligio 8-Mostrar alumnos mayores a 30 de Licenciatura\n");
            break;
...
int menuInformes()
{
    ...
    system("cls");
    printf("****** Informes *******\n\n");
    printf("1-Mostrar Alumno de una carrera\n");
    printf("2-Mostrar Alumnos por carrera\n");
    printf("3-Mostrar lacantidad de Alumnos por carrera\n");
